...
export default function TestimonialsBlock({ id, heading, items = [] }) {
  if (!items || items.length === 0) return null;
  return (
    <section data-block-id={id} className="py-24 md:py-32 px-5 md:px-16 bg-zinc-50">
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {items.map((item, i) => (
            <figure key={i} className="bg-white rounded-3xl p-8 shadow-[0_2px_24px_-6px_rgba(15,23,42,0.08)]">
