...
// Devolució d'un ejemplar comprat (proveïdor o particular) — compartit entre
// /admin/compras/comandes i /admin/compras/particulars perquè ambdós fluxos
// acaben al mateix endpoint `/admin/devolucions/compra`.
export default function DevolucionCompraModal({ item, compraId, onClose, onSaved }) {
  const t = useT();
